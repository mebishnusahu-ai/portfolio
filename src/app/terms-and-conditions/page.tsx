  ...
  return (
    <div className="min-h-screen bg-white">
      <main className="container mx-auto px-8 py-16 lg:py-24 max-w-4xl text-gray-800">
        <h1 className="text-4xl lg:text-5xl font-bold tracking-tighter mb-4 lg:mb-8 text-black">Terms & Conditions</h1>
        <p className="text-sm text-gray-500 mb-8 uppercase tracking-widest">Last updated on 11-04-2026 13:47:26</p>
        ...
        <div className="space-y-6 leading-relaxed text-gray-600">
          <p>
            ...
            agreement by and between DEEPIKA TANDULKAR, ( “Website Owner” or “we” or “us” or “our”) and
          ...
          <ul className="list-disc pl-6 space-y-4">
            ...
            <li>
              ...
              jurisdiction of the courts in Bhilai 1, Chhattisgarh
            </li>
            <li>
